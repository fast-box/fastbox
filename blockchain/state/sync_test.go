...
func makeTestState() (Database, *shxdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := shxdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db shxdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db shxdb.Database, root common.Hash) error {
...
func checkStateConsistency(db shxdb.Database, root common.Hash) error {
