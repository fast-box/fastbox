...
func makeTestState() (Database, *hpbdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := hpbdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db hpbdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db hpbdb.Database, root common.Hash) error {
...
func checkStateConsistency(db hpbdb.Database, root common.Hash) error {
